...
''')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thank you for your feedback."},"errMsg":"Thank you for your feedback."}' in req1:
            print('\033[1;92m[+] Bzhe BATA report rooy')
        else:
            print('\033[0;92m[+] REPORT DONE 👅')
        time.sleep(3)
        req2 = requests.post(url2, json=data2, headers=headers2).text
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thank you for your feedback."},"errMsg":"Thank you for your feedback."}' in req2:
            print('\033[1;92m[+] REPORT DONE 👅')
        else:
            print('\033[0;31m[+] REPORT DONE 👅')
        time.sleep(3)
        req3 = requests.post(url3, json=data3, headers=headers3).text
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thank you for your feedback."},"errMsg":"Thank you for your feedback."}' in req3:
            print('\033[0;92m[+] REPORT DONE 👅')
        else:
            print('\033[0;92m[+] REPORT DONE 👅')
if kurd == '2':
...
if kurd2 == '1':
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thank you for your feedback."},"errMsg":"Thank you for your feedback."}' in req5:
...
if kurd2 == '2':
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thank you for your feedback."},"errMsg":"Thank you for your feedback."}' in req6:
...
if kurd2 == '3':
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thank you for your feedback."},"errMsg":"Thank you for your feedback."}' in req600:
            print('\033[1;92m[+] REPORT DONE 👅')
        else:
            print('\033[0;92m[+] REPORT DONE 👅')
